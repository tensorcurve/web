...
An installable classic WordPress editorial theme for GPU rental economics.

Install the ZIP through Appearance > Themes > Add New > Upload Theme.
Then open Appearance > TensorCurve Setup. Setup is optional and nonce-protected;
content is not created on activation. Sample posts and publication policy pages
are drafts until reviewed and published by the administrator.
...
and per-GPU price tracker pages (H100, H200, A100) with supplier tables, commitment
curves and daily history.
